from game.battles.close_combat.enemy_attack import enemy_attack_close_combat
from game.battles.magic_combat.enemy_attack import enemy_attack_magic_combat
from game.battles.ranged_combat.enemy_attack import enemy_attack_ranged_combat
