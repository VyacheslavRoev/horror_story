...
sword = SimpleSword('Великий половецкий меч', 'дамасская сталь', 30, 15)
bow = SimpleBow('Великий половецкий лук', 'составная кость', 20, 20, 15)
stave = SimpleStave('Великий половецкий посох', 'кости животных и серебро',
                    15, 15)


def polovistan_tournament_gift(hero, weapons, max_health_hero):
    """Подарок половецкого хана."""
